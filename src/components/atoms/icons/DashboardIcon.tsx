  ...
  return (
    <Svg width={size} height={size * 1.1} viewBox="0 0 43 46" fill="none">
      ...
      <Path
        ...
        fill={color}
      />
      <Line x1="24.5" y1="25" x2="24.5" y2="20" stroke={color} strokeWidth="3" />
      <Line x1="29.5" y1="25" x2="29.5" y2="18" stroke={color} strokeWidth="3" />
      <Line x1="34.5" y1="25" x2="34.5" y2="17" stroke={color} strokeWidth="3" />
    </Svg>
  );
};
